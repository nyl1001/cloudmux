...
func init() {
	...
	shellutils.R(&NetworkInterfaceListOptions{}, "network-interface-list", "List network interfaces", func(cli *qcloud.SRegion, args *NetworkInterfaceListOptions) error {
		interfaces, total, err := cli.GetNetworkInterfaces(args.Ids, args.InstanceId, args.Subnet, args.Offset, args.Limit)
		if err != nil {
			return err
		}
		printList(interfaces, total, args.Offset, args.Limit, []string{})
		return nil
	})
}
