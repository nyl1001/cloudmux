...
func init() {
	...
	shellutils.R(&RouteTableListOptions{}, "routetable-list", "List routetables", func(cli *apsara.SRegion, args *RouteTableListOptions) error {
	...
	shellutils.R(&RouteTableShowOptions{}, "routetable-show", "Show routetable", func(cli *apsara.SRegion, args *RouteTableShowOptions) error {
