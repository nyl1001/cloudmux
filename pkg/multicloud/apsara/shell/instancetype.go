...
func init() {
	...
	shellutils.R(&InstanceTypeListOptions{}, "instance-type-list", "List intance types", func(cli *apsara.SRegion, args *InstanceTypeListOptions) error {
	...
	shellutils.R(&InstanceMatchOptions{}, "instance-type-select", "Select matching instance types", func(cli *apsara.SRegion, args *InstanceMatchOptions) error {
