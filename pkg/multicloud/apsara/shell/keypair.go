...
func init() {
	...
	shellutils.R(&KeyPairListOptions{}, "keypair-list", "List keypairs", func(cli *apsara.SRegion, args *KeyPairListOptions) error {
	...
	shellutils.R(&KeyPairImportOptions{}, "keypair-import", "Import a keypair", func(cli *apsara.SRegion, args *KeyPairImportOptions) error {
