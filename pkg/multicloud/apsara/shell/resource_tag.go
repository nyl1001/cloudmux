...
func init() {
	...
	shellutils.R(&TagGetOptions{}, "tag-show", "show tag of a specific resource", func(cli *apsara.SRegion, args *TagGetOptions) error {
	...
	shellutils.R(&TagSetOptions{}, "tag-set", "set tags of a specific resource", func(cli *apsara.SRegion, args *TagSetOptions) error {
