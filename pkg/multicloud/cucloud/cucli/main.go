...
import (
	...
	_ "github.com/nyl1001/cloudmux/pkg/multicloud/cucloud/shell"
)
...
func getSubcommandParser() (*structarg.ArgumentParser, error) {
	parse, e := structarg.NewArgumentParserWithHelp(&BaseOptions{},
		"cucli",
		"Command-line interface to cuc API.",
		`See "cucli COMMAND --help" for help on a specific command.`)
...
func newClient(options *BaseOptions) (*cucloud.SRegion, error) {
	...
	cli, err := cucloud.NewChinaUnionClient(
